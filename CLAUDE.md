...
**iOS:** v0.17.0 — pre-release. WidgetKit widgets (Spending Pace chart, Uncategorized Transactions, Category Rings), manual funding adjustment, tag reclassification, custom Outfit font, tap-to-categorize, split from categorize/edit sheets. See `ios/BudgetApp/CHANGELOG.md` for roadmap to v1.0.0.
