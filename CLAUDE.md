...
**iOS:** v0.8.0 — pre-release. Per-account transaction streaming toggle, accounts page redesign. See `ios/BudgetApp/CHANGELOG.md` for roadmap to v1.0.0.
