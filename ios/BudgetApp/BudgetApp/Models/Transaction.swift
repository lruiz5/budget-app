...
struct Transaction: Codable, Identifiable {
    ...
    init(id: Int, budgetItemId: Int? = nil, linkedAccountId: Int? = nil, date: Date = Date(), description: String, amount: Decimal, type: TransactionType, merchant: String? = nil, tellerId: String? = nil, deletedAt: Date? = nil, suggestedBudgetItemId: Int? = nil, fromPreviousMonth: Bool? = nil, splits: [SplitTransaction]? = nil) {
        self.id = id
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case tellerId, deletedAt, suggestedBudgetItemId, fromPreviousMonth, splits
    }
